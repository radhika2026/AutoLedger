...
def car_update(record, data):
    ...
    #payload = RetrieveCarTransaction(
    #            chassisNo=json_data["asset"]["data"]["chassisNo"],
    #            engineNo=json_data["asset"]["data"]["engineNo"],
    #            manufacturer=json_data["asset"]["data"]["manufacturer"],
    #            manufacturingDate=json_data["asset"]["data"]["manufacturingDate"],
    #            numberPlate=json_data["asset"]["data"]["numberPlate"],
    #            registerDate=json_data["asset"]["data"]["registerDate"],
    #            ownerHistory=[
    #                OwnerHistory(
    ...
    #                )
    #                for owner in json_data["asset"]["data"]["ownerHistory"]
    #                ],
    #            drivingLicense=json_data["asset"]["data"]["drivingLicense"],
    #            color=json_data["asset"]["data"]["color"],
    #            seating=json_data["asset"]["data"]["seating"],
    #            transmission=json_data["asset"]["data"]["transmission"],
    #            wheelBase=json_data["asset"]["data"]["wheelBase"],
    #            groundClearance=json_data["asset"]["data"]["groundClearance"],
    #            driveType=json_data["asset"]["data"]["driveType"],
    #            fuelType=json_data["asset"]["data"]["fuelType"],
    #            carClass=json_data["asset"]["data"]["carClass"],
    #            model=json_data["asset"]["data"]["model"],
    #            insuranceNo=json_data["asset"]["data"]["insuranceNo"],
    #            insuranceProvider=json_data["asset"]["data"]["insuranceProvider"],
    #            policyEndDate=json_data["asset"]["data"]["policyEndDate"],
    #            insuranceHistory=[
    #                InsuranceHistory(
    #                   date=insurance["date"],
    #                   cost=insurance["cost"],
    #                   description=insurance["description"]
    #                ) for insurance in json_data["asset"]["data"]["insuranceHistory"]
    #            ],
    #            mileage=json_data["asset"]["data"]["mileage"],
    #            odometerReading=json_data["asset"]["data"]["odometerReading"],
    #            servicingHistory=[
    #                ServicingHistory(
    ...
    #                )
    #                for service in json_data["asset"]["data"]["servicingHistory"]
    #            ]
    #            )
    return payload
...
#
    ...
    def getAllCarTransactions(self, id: strawberry.ID) -> List[RetrieveCarTransaction]:
        ...
        for js_data in json_data:
            data = js_data.get("asset", {}).get("data", {})
            try:
...
class Mutation:
    ...
    def updateCarTransaction(self, data: PrepareAsset) -> RetrieveCarTransaction:
        ...
        url = f"{protocol}{db_root_url}{fetch_all_endpoint}"
        asset=ast.literal_eval(data.asset)
        number_plate = asset["data"]["numberPlate"]
