          ...
          <Form className="p-3 border rounded">
            <Form.Group>
              ...
              >
                ...
                <option value="Add insurance details">
                  Add insurance details
                </option>
                <option value="Search by Plate">Search by Plate</option>
                <option value="Update insurance details">
            ...
            {operation === "Add insurance details" && (
              <>
                ...
                <Form.Group className="mb-3">
                  ...
                  />
                  {carDetails.licensePlate.length < 6 ||
                  carDetails.licensePlate.length > 8 ? (
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Input
                      ...
                      value={carDetails.drivingLicenseNumber}
                      onChange={handleCarDetailsChange}
                    />
                    {carDetails.drivingLicenseNumber.length < 8 ||
                    carDetails.drivingLicenseNumber.length > 10 ? (
                      <Form.Text className="text-danger">
                        Insurance number must be 8 to 10 characters long.
                      </Form.Text>
                    ) : (
                      <></>
                    )}
